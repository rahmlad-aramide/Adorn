...
const Hero = () => {
  ...
  return (
    <section className="min-h-screen bg-amber-900/50 bg-hero bg-cover bg-center shadow-lg">
      ...
      <div className="flex h-screen w-full flex-col justify-start pt-[4.3125rem] md:flex-row md:justify-end">
        ...
        >
          <div className="mr-0 -mt-16 flex aspect-square h-fit max-w-fit cursor-pointer flex-col items-center justify-center rounded-full bg-white px-4 font-workSans text-lg font-medium transition duration-200 hover:scale-90 active:scale-100 md:-mr-[6rem] md:mt-[45vh] md:max-w-[20ch]">
            <div className="max-w-[8ch] px-3 text-center md:max-w-full">
              Go to catalog
            </div>
        ...
        <div className="order-1 flex h-fit min-h-[250px] w-full flex-col justify-start bg-white/50 pb-16 pt-4 backdrop-blur-lg md:order-2 md:h-full md:w-[45%] md:pt-[4.3125rem]">
          <h1 className="text-center font-lancelot text-[4rem] leading-[3rem] text-[#111] md:text-[8.125rem] md:leading-[6.25rem]">
            Adorn <br />{" "}
