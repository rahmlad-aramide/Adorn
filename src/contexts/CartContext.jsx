...
const CartProvider = ({ children }) => {
    ...
    useEffect(() => {
        const currentTotal = cartItems.reduce((total, cartItem) => total + (discountCalc(cartItem.price, cartItem.discount) * cartItem.quantity), 0);
    ...
    const value = { cartItems, cartCount, totalCount, addItemToCart, reduceItemQuantity, removeItemFromCart }
